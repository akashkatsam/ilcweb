              ...
              <div className='col-md-10 p-0'>
                <div className='centernavitem'>
                  <ul>
                    ...
                    <li><Link to="/about" onClick={closeMenu} className={location.pathname === "/about" ? "active" : ""}
                    >
                      About
                    </Link>
                    ...
                    <li>
                      ...
                      <Link to="/media" onClick={closeMenu} className={location.pathname === "/media" ? "active" : ""}>
                        Media
                      </Link>
                    </li>
                    ...
                    {/* <li >
                      <Link to="/blog" onClick={closeMenu} className={location.pathname === "/blog" ? "active" : ""}>
                        Blog
                      </Link>
                    </li> */}
                    ...
                    <li>
                      <Link to="/photos" onClick={closeMenu} className={location.pathname === "/photos" ? "active" : ""}>
                        Gallery
                      </Link>
                    </li>
